(custom-set-variables
 ...
 '(package-selected-packages
   '(treemacs-icons-dired timu-rouge-theme esh-autosuggest amx no-littering all-the-icons-dired dired-sidebar rime zweilight-theme diminish git-gutter symbol-overlay centaur-tabs magit powerline display-time-mode doom-modeline-icon org-cua-dwim treemacs-all-the-icons atom-one-dark-theme monokai-theme dracula-theme all-the-icons zygospore zzz-to-char lsp-treemacs treemacs-projectile treemacs counsel-projectile projectile lsp-ui yasnippet-snippets yasnippet lsp-ivy lsp-mode company-box company dashboard rainbow-delimiters marginalia which-key smart-mode-line good-scroll undo-tree ace-window counsel mwim flycheck)))
...
(defun centaur-setup-fonts ()
  ...
  (when (display-graphic-p)
    ;; Set default font
    (set-face-attribute 'default nil :family "LXGW WenKai" :height 130)
